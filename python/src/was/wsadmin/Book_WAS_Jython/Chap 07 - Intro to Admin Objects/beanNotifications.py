...
#----------------------------------------------------------------------
# Name: beanNotifications()
#----------------------------------------------------------------------
def beanNotifications():
  try :
    ...
    for bean in beans :
      ...
      info[ kind ] = Help.notifications( bean ).replace( '\r', '' )
    ...
    names.sort()
    #------------------------------------------------------------------
    # For each type, display the type value, and its indented
    # notifications
    #------------------------------------------------------------------
    for name in names :
      print '%s\n%s' % ( name, info[ name ].replace( '\n', '\n  ' ) )
...
#---------------------------------------------------------------------
def Usage( cmd = 'beanNotifications' ) :
  print '''     File: %(cmd)s.py\n
     Role: Script used to display notification information for the
